...
// target = object3D.parent.worldToLocal(wpVector);



          //  var centerTrash = new THREE.Vector3();
          //  this.el.object3D.getCenter( centerTrash );
            ...
            return function () {
              ...
              // target3D.getCenter(wpVector);
            this.el.object3D.getCenter(target);
...
{location: {lat: 42.78172972990168,  lng: -88.96262094120564 },},
      ...
      //RENDER THE SECOND(CU) BUSINESS' 3D MODEL OR LOGO - AND SET THE OBJECTS ATTRIBUTES
       function renderPlacesTrash(placesTrash) {
        ...
        // placesTrash.getCenter(target);

          placesTrash.forEach((placeTrash) => {
      
           // target.getCenter(new THREE.Vector3() ) 
        ...
        // let center = placeTrash.getCenter();
         ...
         let modelHeight = [(p + t) * 0.33];
          ...
          // var center = new THREE.Vector3();
          // modelTrash.getCenter(target=center);
